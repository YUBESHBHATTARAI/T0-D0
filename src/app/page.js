      ...
      <div>
        <div>
          ...
          <div className="flex flex-col items-center justify-center ring-2 ring-white rounded-xl w-[96vw] md:w-[60vw] lg:w-[45vw] xl:w-[35vw] mx-auto gap-1">
            <input
              className="px-6 py-2 mx-2 my-3 ring-1 ring-gray-300 rounded-md"
              type="text"
            ...
            />
            <button
              className="text-white text-4xl rounded-md hover:cursor-pointer mb-2"
              onClick={addData}
            >
            ...
            <ul>
              {data.map((item, value) => (
                ...
                >
                  <span className="text-4xl rounded-md hover:cursor-pointer font-[Inter] text-white">
                    {item}
                  </span>
                  <div className="flex gap-3">
                    <button
                      className="text-white text-3xl font-thin rounded-md hover:cursor-pointer"
                      onClick={() => deleteData(item)}
                    >
                      <span className="text-2xl font-bold bg-gray-300 text-black p-1 rounded-md">
                        &#10005;
                      </span>
                    </button>
                    <button
